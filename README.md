...
3. ***Optional:*** You can open the yaml file using notepad and modify the list of vowels to suit your voicebank. Other phonemes would be considered consonants.
